...
base {
    archivesName = "${project.name.replace(" ", "")}-$minecraftVersion"
...
dependencies {
    ...
    implementation(fg.deobf(libs.titanium.get()))
    implementation(fg.deobf(libs.industrialForegoing.get()))
    ...
    processResources {
        val prop = mapOf(
            ...
            "dependencies" to buildDeps(
                ...
                ModDep("industrialforegoing", "3.5.7"),
            ),
        )
