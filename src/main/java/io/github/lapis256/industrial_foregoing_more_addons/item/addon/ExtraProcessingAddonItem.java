...
public class ExtraProcessingAddonItem extends ProcessingAddonItem {
    private final int tier;

    public ExtraProcessingAddonItem(int tier, TitaniumTab group) {
        super(tier, group);
        this.tier = tier;
    }
    ...
    public void registerRecipe(Consumer<FinishedRecipe> consumer) {
        ...
        new DissolutionChamberRecipe(
                ...
                new Ingredient.Value[]{
                        ...
                        new Ingredient.TagValue(tierMaterial),
                        new Ingredient.ItemValue(new ItemStack(net.minecraft.world.item.Items.FURNACE)),
                        new Ingredient.ItemValue(new ItemStack(net.minecraft.world.item.Items.CRAFTING_TABLE))
                },
