...
public class ForceLensAddonItem extends AddonItem implements ISpecialCreativeTabItem {
    public static final IAugmentType FORCE_LENS = () -> "ForceLens";

    public ForceLensAddonItem(TitaniumTab group) {
        super("force_lens_addon", group, new Properties().stacksTo(16));
    }

    @Override
    public void onCraftedBy(@NotNull ItemStack stack, @NotNull Level level, @NotNull Player player) {
        super.onCraftedBy(stack, level, player);
        AugmentWrapper.setType(stack, FORCE_LENS, 1f);
    }
    ...
    public void registerRecipe(Consumer<FinishedRecipe> consumer) {
        new DissolutionChamberRecipe(
                ...
                new Ingredient.Value[]{
                        ...
                        new Ingredient.TagValue(IFMATags.LENS),
    ...
    public @NotNull String getDescriptionId() {
        ...
        return prefix + Component.translatable(IndustrialForegoingMoreAddons.tKey("force_lens_addon")).getString();
    }
